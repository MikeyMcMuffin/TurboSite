...
// Set Variables
$LOCAL_ROOT         = "/var/www/dev.mcmuffins.com";
$LOCAL_REPO_NAME    = "TurboSite";
$LOCAL_REPO         = "{$LOCAL_ROOT}/{$LOCAL_REPO_NAME}";
$REMOTE_REPO        = "git@github.com:MikeyMcMuffin/TurboSite.git";
$BRANCH             = "Development";
...
if ( $_POST['payload'] ) {
  ...
  if( file_exists($LOCAL_REPO) ) {
    ...
    shell_exec("cd {$LOCAL_ROOT} && git clone {$REMOTE_REPO} && git fetch && git checkout {$BRANCH}");
